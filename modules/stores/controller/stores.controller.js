...
const addStore = async (req, res) => {
    const { storeName, telephoneNumber, storeWebsite, storeCategories, canBeAddedToCart, isComparable, storeLogoURL } = req.body;
    try {
        if (storeLogoURL) {
            ...
            if (store) {
                ...
                let newStore = new Store({
                    storeName, telephoneNumber, storeWebsite, storeCategories, canBeAddedToCart, isComparable,
